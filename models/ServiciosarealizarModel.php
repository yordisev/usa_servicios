...
se.nombre, s.fecha_inicio,s.fecha_fin,s.total_a_pagar,s.fecha,s.estado_servico
...
{
    require_once('../config/config.php');
    $query = $mysqli->prepare("INSERT INTO servicios_a_realizar (cliente, servicio, fecha_inicio, hora_inicio, fecha_fin, hora_fin,
    total_a_pagar,fecha,estado_servicio) VALUES (?,?,?,?,?,?,NOW(),'A')");
