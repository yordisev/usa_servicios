...
INSERT INTO `servicios_a_realizar` (`id_ser_rea`, `id_servicio_cliente`, `cliente`, `servicio`, `fecha_inicio`, `hora_inicio`, `fecha_fin`, `hora_fin`, `total_a_pagar`, `fecha`, `estado_servicio`) VALUES
	(1, 1, 2148124, '4', '2022-01-31', '16:37:00', '2022-01-31', '16:40:00', 200, '2022-01-31', 'A'),
	(2, 1, 24234, '2', '2022-01-31', NULL, '2022-01-31', NULL, 300, '2022-01-31', 'T'),
	(3, 1, 12345, '3', '2022-01-21', '14:30:00', '2022-01-28', '14:30:00', NULL, '2022-01-31', 'A'),
	(4, 1, 987654321, '3', '2022-01-21', '14:39:00', '2022-01-31', '14:38:00', NULL, '2022-01-31', 'A'),
	(5, 1, 1271273197, '3', '2022-01-13', '14:45:00', '2022-01-19', '14:44:00', NULL, '2022-01-31', 'A'),
	(6, 2, 1271273197, '2', '2022-01-11', '14:45:00', '2022-01-27', '14:44:00', NULL, '2022-01-31', 'T'),
	(7, 2, 2138127, '2', '2022-01-06', '14:48:00', '2022-01-19', '14:47:00', NULL, '2022-01-31', 'A'),
	(10, 2, 12345, '2', '2022-01-26', '14:51:00', '2022-01-31', '14:48:00', NULL, '2022-01-31', 'A'),
	(11, 2, 24234, '2', '2022-01-13', '18:48:00', '2022-01-31', '14:50:00', NULL, '2022-01-31', 'A'),
	(12, 1, 2148124, '4', '2022-02-10', '21:44:00', '2022-02-25', '18:47:00', NULL, '2022-02-08', 'A'),
	(13, 2, 14812498, '4', '2022-02-04', '18:50:00', '2022-02-18', '18:53:00', NULL, '2022-02-08', 'A');
...
-- Volcando estructura para tabla servicios_db.servicios_clientes
CREATE TABLE IF NOT EXISTS `servicios_clientes` (
  `id_servicio_cliente` int(11) NOT NULL AUTO_INCREMENT,
  `cliente` int(11) DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `estado` varchar(50) DEFAULT NULL,
...
-- Volcando datos para la tabla servicios_db.servicios_clientes: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `servicios_clientes` DISABLE KEYS */;
INSERT INTO `servicios_clientes` (`id_servicio_cliente`, `cliente`, `fecha`, `estado`) VALUES
	(1, 2148124, '2022-02-08', 'A'),
	(2, 14812498, '2022-02-08', 'A');
